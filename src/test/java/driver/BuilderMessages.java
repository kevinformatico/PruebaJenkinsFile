...
public class BuilderMessages {
    ...
    public static String buildNetworkEmulationOffline(){
        String message = String.format("{\"id\": 7,\"method\": \"Network.emulateNetworkConditions\",\"params\": {\"offline\": true,\"latency\": 10000,\"downloadThroughput\":1 ,\"uploadThroughput\": 1}}");
        System.out.println(message);
        return message;
    }

    public static String buildBrowserClose(){
        String message = String.format("{ \"id\":8,\"method\":\"Browser.close\"}");
        System.out.println(message);
        return message;
    }

    public static String buildBrowserCrash(){
        String message = String.format("{ \"id\":8,\"method\":\"Browser.crash\"}");
        System.out.println(message);
        return message;
    }

    public static String buildNetworksetBlockedURLs(){
        String message = String.format("{ \"id\":8,\"method\":\"Network.setBlockedURLs\",\"params\": {\"urls\": [\"*\"]}}");
        System.out.println(message);
        return message;
    }
}
